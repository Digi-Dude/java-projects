...
public class Main {
    private static final Logger exceptions = LogManager.getRootLogger();
    private static final Logger inputErrors = LogManager.getLogger("input_errors");
    private static final Logger search = LogManager.getLogger("search");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                search.info("correct input " + line);
                return station;
            }
            inputErrors.info("incorrect input " + line);
